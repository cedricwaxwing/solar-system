...
const Sidebar = ({ fade, display, setShowInfo }) => {
  ...
  return currentPlanet ? (
    <>
      ...
      <div className='flex flex-col justify-center md:justify-between absolute bottom-4 right-4 md:w-full md:max-w-[400px] max-md:left-4 max-md:top-[80px]'>
        <div className='space-y-4'>
          <animated.div
            className='bg-gray-800/30 shadow-2xl shadow-gray-900/80 md:shadow-gray-900/20 rounded-2xl border-2 border-white/10 backdrop-blur-2xl max-h-[calc(100vh-250px)] md:flex md:flex-col md:flex-grow relative'
            style={{
              ...fade,
              display: display,
            }}>
